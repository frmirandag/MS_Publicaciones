...
public class PublicacionController {
    ...
    public CollectionModel<EntityModel<Publicacion>> getAllPublicaciones() {
        ...
        CollectionModel<EntityModel<Publicacion>> resources = CollectionModel.of(publicacionResources, linkTo.withRel("publicaciones"));
    ...
    public ResponseEntity<Object> getPublicacionById(@PathVariable Long id) {  
        Optional<Publicacion> publicacionModel = publicacionService.getPublicacionById(id);
    ...
    @PostMapping
    public ResponseEntity<Object> createPublicacion(@RequestBody Publicacion publicacionModel) {
        Publicacion createPublicacion = publicacionService.createPublicacion(publicacionModel);
    ...
    //METODO ACTUALIZAR
    @PutMapping("/{id}")
    public Publicacion updatePublicacion(@PathVariable Long id, @RequestBody Publicacion publicacionModel){
